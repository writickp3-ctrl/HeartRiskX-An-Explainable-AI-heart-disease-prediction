...
import sklearn  # noqa: F401  — must be imported before lightgbm (Windows import-order quirk:
# LightGBM's internal scikit-learn compatibility check can silently fail if lightgbm
# is imported first, even when scikit-learn is correctly installed)
import joblib
import numpy as np
import pandas as pd
